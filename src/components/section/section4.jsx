        ...
        {cards.map((card) => (
          <Grid item key={card}>
            ...
            sx={{ 
             ...
             <CardContent sx={{ display: "flex", flexDirection: "column",position:"relative", justifyContent: "space-between", height: "100%" }}>
                <Typography sx={{ fontSize: 14 ,position:"absolute",top:"20px",right:"90px"}} color="#4187AE" >
                  {card.title}
                </Typography>
                <Typography variant="h5" component="div" sx={{ marginTop: "4rem" }}>
                  {card.text}
                </Typography>
                ...
                <Button
                 ...
                 "&:hover": {
                  ...
                  color: "#fff",
                      ...
                      <KeyboardArrowRightIcon/><KeyboardArrowRightIcon sx={{opacity:"0.6",marginLeft:"-15px"}}/>خریداین پکیج</Button>
                 </CardContent>
            </Card>
          </Grid>
        ))}
